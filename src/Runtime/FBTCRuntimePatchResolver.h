...
typedef NS_ENUM(NSInteger, FBTCRuntimePatchStrategy) {
    FBTCRuntimePatchStrategyNone = 0,
    FBTCRuntimePatchStrategyObjCBool,
    FBTCRuntimePatchStrategyFunctionBool,
    FBTCRuntimePatchStrategyFunctionTyped,
    FBTCRuntimePatchStrategyFunctionObserve,
    FBTCRuntimePatchStrategyDataReaderBool,
    FBTCRuntimePatchStrategyDataRebindString,
    FBTCRuntimePatchStrategyDataPatchBytes,
};

@interface FBTCRuntimePatchPlan : NSObject <NSCopying>
...
@property (nonatomic, assign) FBTCRuntimePatchStrategy strategy;
...
@interface FBTCRuntimePatchResolver : NSObject
...
// objcClassMethod.
+ (FBTCRuntimePatchPlan *)resolvePlanForEntryInfo:(NSDictionary<NSString *, id> *)entryInfo
                                         xrefHits:(nullable NSArray<FBTXrefHit *> *)xrefHits;
...
+ (nullable id)currentForcedValueForPlan:(FBTCRuntimePatchPlan *)plan;
+ (nullable id)currentNativeValueForPlan:(FBTCRuntimePatchPlan *)plan;
...
// Observe -> nil.
+ (BOOL)applyPlan:(FBTCRuntimePatchPlan *)plan value:(nullable id)value error:(NSError **)error;
