...
@interface FBTRuntimeXrefScanner : NSObject
...
+ (void)findConsumersOfAddress:(uintptr_t)targetAddress
                 imageSubstring:(nullable NSString *)imageSubstring
                        ...
                        maxHits:(int)maxHits
                     completion:(void (^)(NSArray<FBTXrefHit *> *hits, BOOL hitBudget))completion;
