...
- (NSString *)tableView:(UITableView *)tv titleForFooterInSection:(NSInteger)s {
    if (s == FBGRRootSectionProviders) {
        ...
        return [NSString stringWithFormat:@"%lu overrides ativos | %lu params | fonte: %@", (unsigned long)tot, (unsigned long)cat, [FBGRMCCatalog shared].sourcePath ?: @"?"];
    }
