...
- (instancetype)initWithProvider:(FBGRGateProvider *)p {
    ...
    _provider = p;
    self.title = p ? [NSString stringWithFormat:@"%@ · Runtime", p.title] : @"Runtime MobileConfig";
    return self;
}
...
- (void)viewDidLoad {
    ...
    _search.searchBar.placeholder = @"Buscar group:param do ReactMobileConfigMetadata";
